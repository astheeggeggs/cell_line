...
# plink --vcf /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/UKB_imputed_subset/UKB_imputed_subset_chr${chr}_thresholded.vcf.gz --out /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/UKB_imputed_subset/UKB_imputed_subset_chr${chr}_thresholded_recode --real-ref-alleles --make-bed
...
# # Then recode to vcf
# plink --bfile /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/UKB_imputed_subset/UKB_imputed_subset_chr${chr}_thresholded_recode --real-ref-alleles --recode vcf --out /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/UKB_imputed_subset/UKB_imputed_subset_chr${chr}_thresholded_recode_final --double-id
