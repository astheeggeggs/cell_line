...
perl HRC-1000G-check-bim.pl -b data/combined/UKB_subset_combined.bim -f data/combined/UKB_subset_combined.frq -t 0.3 -r ${RefPanel} -h
...
for chr in {1..23}
do
    bgzip UKB_subset_combined-updated-chr${chr}.vcf
done
