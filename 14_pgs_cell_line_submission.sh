...
pgs-calc apply \
	...
	${imputed_path}/chr*_UKB_cell_line_1000G_intersected.dose.vcf.gz \
	--out ${pgs_results_dir}/cell_line_job_${SLURM_ARRAY_TASK_ID}/cell_line_intersect_UKB_1000G_job_${SLURM_ARRAY_TASK_ID}_scores.txt \
	--dbsnp /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/dbsnp154_hg19.txt.gz \
	--report-html ${pgs_results_dir}/cell_line_job_${SLURM_ARRAY_TASK_ID}/cell_line_intersect_UKB_1000G_job_${SLURM_ARRAY_TASK_ID}_scores_report.html \
	--genotypes GT \
	--meta ${pgs_score_dir}/pgs-catalog-20221123-hg19/scores.meta.json \
	--report-csv ${pgs_results_dir}/cell_line_job_${SLURM_ARRAY_TASK_ID}/cell_line_intersect_UKB_1000G_job_${SLURM_ARRAY_TASK_ID}_scores_report.csv
