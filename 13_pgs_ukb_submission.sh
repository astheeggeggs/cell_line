...
pgs-calc apply \
	...
	--out ${pgs_results_dir}/ukb_job_${SLURM_ARRAY_TASK_ID}/ukb_intersect_1000G_cell_line_job_${SLURM_ARRAY_TASK_ID}_scores.txt \
	--dbsnp /well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/dbsnp154_hg19.txt.gz \
	--report-html ${pgs_results_dir}/ukb_job_${SLURM_ARRAY_TASK_ID}/ukb_intersect_1000G_cell_line_job_${SLURM_ARRAY_TASK_ID}_scores_report.html \
	--genotypes GT \
	--meta ${pgs_score_dir}/pgs-catalog-20221123-hg19/scores.meta.json \
	--report-csv ${pgs_results_dir}/ukb_job_${SLURM_ARRAY_TASK_ID}/ukb_intersect_1000G_cell_line_job_${SLURM_ARRAY_TASK_ID}_scores_report.csv
