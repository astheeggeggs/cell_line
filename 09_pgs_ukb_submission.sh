...
ukb_imputed_intersected_subset_dir="/well/lindgren/UKBIOBANK/dpalmer/PRS_cell_data/data/UKB_imputed_subset/UKB_cell_line_intersection"
...
gzip -f ${pgs_results_dir}/ukb_job_${SLURM_ARRAY_TASK_ID}/ukb_job_${SLURM_ARRAY_TASK_ID}_scores_variants_used.csv
